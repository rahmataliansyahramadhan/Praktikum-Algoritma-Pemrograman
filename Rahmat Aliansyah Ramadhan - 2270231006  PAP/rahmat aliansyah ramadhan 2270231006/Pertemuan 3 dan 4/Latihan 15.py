...
print("index ke-[6,8) : " + nama_lengkap[6:8]) # dimulai dari index 6sampai sebelum 8
print("index ke-[0,2,4,6,8] : " + nama_lengkap[0:10:2]) # diambil index0,2,4,6,8
...
# 4. operator dalam bentuk methoddata = "otong surotong pararotong"
